...
void main() {
  ...
  late ICollectionRepository collectionRepository;
  ...
  group('GET', () {
    test('Check if .list is building a correct url and returning a correct map',
      ...
      // act
      final res = await collectionRepository.list(dbId: 'testDb');
    ...
    test('Check if .get is building a correct url and returning a correct map',
      ...
      // act
      final res = await collectionRepository.get(
    ...
    test(
      ...
      // act
      final res =
          await collectionRepository.get(dbId: 'error', collectionId: 'error');
  ...
  group('POST', () {
    test(
      ...
      // act
      final res = await collectionRepository.create(
        dbId: 'testDb',
  ...
  group('DELETE', () {
    test(
      ...
      // act
      final res = await collectionRepository.delete(
        dbId: 'testDb',
        collectionId: 'testCollection',
      );
