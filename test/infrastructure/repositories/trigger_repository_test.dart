...
void main() {
  ...
  group('GET', () {
    test('Check if .list is building a correct url and returning a correct map',
      ...
      // act
      final res = await triggerRepository.list(
        dbId: 'testDb',
  ...
  group('POST', () {
    test(
      ...
      // act
      final res = await triggerRepository.create(
        dbId: 'testDb',
        collectionId: 'testColl',
        function: '',
  ...
  group('PUT', () {
    test(
      ...
      // act
      final res = await triggerRepository.replace(
        dbId: 'testDb',
        collectionId: 'testColl',
        function: '',
        triggerId: 'testTrigger',
  ...
  group('DELETE', () {
    test(
      ...
      // act
      final res = await triggerRepository.delete(
        dbId: 'testDb',
        collectionId: 'testColl',
        triggerId: 'testTrigger',
      );
